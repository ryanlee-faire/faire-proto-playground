...
export const prototypes: Prototype[] = [
  ...
  },
  {
    ...
    description: 'Full surface page for Compass interface (Cristi). Explores the full-page Compass experience beyond the side panel.',
    owner: 'Ryan',
  ...
  {
    id: 'compass-contained',
    name: '🧭 Compass Ecosystem Approach',
    path: '/compass-contained/home',
    description: 'Isolated Compass flow starting with John\'s homepage prototype. Explores a contained ecosystem approach to Compass integration.',
    owner: 'Ryan',
    lastUpdated: '2024-11-23',
    surfaceArea: 'Retailer',
    category: 'experimental',
  ...
  {
    id: 'pdp-v2-with-ai',
    name: 'PDP with AI overview',
    path: '/pdp-v2-with-ai',
    description: 'Product detail page with AI-powered overview and search. Features Compass drawer integration for product questions.',
    owner: 'Ryan',
    lastUpdated: '2024-11-23',
    surfaceArea: 'Retailer',
    category: 'experimental',
  ...
  {
    id: 'pdp-v2-with-ai-inline',
    name: 'PDP with AI overview (inline)',
    path: '/pdp-v2-with-ai-inline',
    description: 'Product detail page with AI answers displayed inline in the Overview section. Alternative to drawer-based interaction.',
    owner: 'Ryan',
    lastUpdated: '2024-11-23',
    surfaceArea: 'Retailer',
    category: 'experimental',
  ...
  {
    id: 'brand-page-v2',
    name: 'Brand Page V2 (with AI summary)',
    path: '/brand/casa-bosques/v2',
    description: 'Brand page variant with AI summary box and action buttons positioned on banner image.',
    owner: 'Ryan',
    lastUpdated: '2024-11-23',
    surfaceArea: 'Retailer',
    category: 'experimental',
